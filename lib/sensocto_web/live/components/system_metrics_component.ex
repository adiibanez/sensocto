  ...
  def render(assigns) do
    ...
    <div id={@id} phx-hook="SystemMetricsRefresh" phx-target={@myself}>
      <.link
        ...
        class="flex items-center gap-2 text-xs font-mono hover:bg-gray-700/50 rounded-lg px-2 py-1 transition-colors"
      ...
      >
        ...
        <div
          ...
          title="Batch Window Multiplier (higher = slower updates when load is high)"
        >
