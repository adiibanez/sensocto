defmodule SensoctoWeb.Components.Menu do
  @moduledoc """
  The `SensoctoWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  import SensoctoWeb.Components.Accordion, only: [accordion: 1]
  import SensoctoWeb.Components.Button, only: [button_link: 1]
