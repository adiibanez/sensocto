defmodule SensoctoWeb.Components.Tabs do
  @moduledoc """
  `SensoctoWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import SensoctoWeb.Components.Badge, only: [badge: 1]
