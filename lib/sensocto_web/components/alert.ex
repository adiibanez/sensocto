defmodule SensoctoWeb.Components.Alert do
  @moduledoc """
  SensoctoWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
  ...
  use Gettext, backend: SensoctoWeb.Gettext
