...
SMTP2GO_APIKEY=api-8C229504AB2F45248218104C8732F36D ERLANG_COOKIE=testlitest AUTH_USERNAME=admin AUTH_PASSWORD=nimda_1234 iex --name "node@localhost" --cookie testlitest -S mix phx.server
