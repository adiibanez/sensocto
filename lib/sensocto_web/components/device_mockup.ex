defmodule SensoctoWeb.Components.DeviceMockup do
  @moduledoc """
  The `SensoctoWeb.Components.DeviceMockup` module provides a customizable component for displaying
  ...
  import SensoctoWeb.Components.Image, only: [image: 1]
