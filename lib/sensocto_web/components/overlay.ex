defmodule SensoctoWeb.Components.Overlay do
  @moduledoc """
  The `SensoctoWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `SensoctoWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
