defmodule SensoctoWeb.Components.Stepper do
  @moduledoc """
  The `SensoctoWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `SensoctoWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
