defmodule SensoctoWeb.Components.Banner do
  @moduledoc """
  SensoctoWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
