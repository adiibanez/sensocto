defmodule SensoctoWeb.CallChannel do
  ...
  def handle_in("join_call", _params, socket) do
    ...
    Logger.debug("CallChannel: User #{user_id} attempting to join call in room #{room_id}")
  ...
  def handle_info({:media_event, event}, socket) do
    ...
    Logger.debug("CallChannel: Forwarding media event to #{socket.assigns.user_id}")
