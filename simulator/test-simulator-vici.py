...
async def send_sensor_data(client, sensor_id, sensor_type, duration, sampling_rate, heart_rate=None, respiratory_rate=None,
...
async def main():
    ...
    parser.add_argument("sensor_type", type=str, help="The sensor type to simulate (ecg, ppg, rsp, eda, emg, heartrate).")
    ...
    await client.subscribe(f"sensor_data:{sensor_id_string}", {"device_name": sensor_id})
    await client.connect()

    while True:  # Loop indefinitely
        await send_sensor_data(client, sensor_id_string, sensor_type, duration, sampling_rate, heart_rate, respiratory_rate, scr_number,
                               burst_number)
