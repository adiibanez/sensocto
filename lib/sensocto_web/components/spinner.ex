defmodule SensoctoWeb.Components.Spinner do
  @moduledoc """
  The `SensoctoWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `SensoctoWeb.Components.Spinner` module enables developers to provide
