defmodule SensoctoWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `SensoctoWeb.CoreComponents` functions you should expect identical functionality for similarly named
