defmodule SensoctoWeb.Components.CheckboxField do
  @moduledoc """
  SensoctoWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
