  ...
  deephouse: {
    bass: {
      ...
      options: {
        ...
        envelope: { attack: 0.003, decay: 0.18, sustain: 0.55, release: 0.12 },
        filter: { Q: 6, type: 'lowpass', rolloff: -24 },
        filterEnvelope: { attack: 0.003, decay: 0.12, sustain: 0.2, release: 0.08, baseFrequency: 60, octaves: 3.5 },
      },
      volume: -5,
    },
    pad: {
      ...
      options: {
        ...
        envelope: { attack: 1.0, decay: 0.8, sustain: 0.75, release: 2.5 },
        modulation: { type: 'sine' },
        modulationEnvelope: { attack: 0.8, decay: 0.6, sustain: 0.5, release: 2.0 },
      },
      volume: -17,
    },
    lead: {
    ...
    drums: {
      kick:      { pitchDecay: 0.18, octaves: 9, envelope: { attack: 0.001, decay: 0.55, sustain: 0 } },
      snare:     { type: 'white', attack: 0.001, decay: 0.16 },
      closedHat: { frequency: 450, harmonicity: 5.1, modulationIndex: 38, resonance: 7000, octaves: 1.5, decay: 0.035 },
      openHat:   { frequency: 450, harmonicity: 5.1, modulationIndex: 38, resonance: 6000, octaves: 1.5, decay: 0.4 },
      clap:      { type: 'white', attack: 0.004, decay: 0.2 },
    ...
    effects: {
      reverbDecay: 4.5, reverbWet: 0.28,
      delayTime: '8n.', delayFeedback: 0.22, delayWet: 0.18,
      chorusFreq: 1.2, chorusDepth: 0.45, chorusWet: 0.35,
      compThreshold: -12, compRatio: 4, compAttack: 0.003, compRelease: 0.08,
    },
  },
};
