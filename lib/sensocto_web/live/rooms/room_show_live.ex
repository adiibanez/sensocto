      ...
      {:ok, room} ->
        ...
        socket =
          ...
          |> attach_hook(
            :media,
            :handle_info,
            &SensoctoWeb.RoomShowLive.Hooks.MediaHook.on_handle_info/2
          )
          |> attach_hook(
            :object3d,
            :handle_info,
            &SensoctoWeb.RoomShowLive.Hooks.Object3DHook.on_handle_info/2
          )
          |> attach_hook(
            :whiteboard,
            :handle_info,
            &SensoctoWeb.RoomShowLive.Hooks.WhiteboardHook.on_handle_info/2
          )
          |> attach_hook(
            :call,
            :handle_info,
            &SensoctoWeb.RoomShowLive.Hooks.CallHook.on_handle_info/2
          )
