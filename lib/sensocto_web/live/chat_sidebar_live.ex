defmodule SensoctoWeb.ChatSidebarLive do
  @moduledoc """
  Desktop chat sidebar LiveView.
  ...
  def render(assigns) do
    ...
    <div id="chat-sidebar-wrapper" class="hidden md:block" phx-hook="ChatSidebarHook">
      ...
      <aside
        :if={@open}
        id="chat-sidebar"
        class="fixed top-0 end-0 h-screen w-80 bg-gray-800 border-l border-gray-700 z-30 transition-transform transform-none"
      >
